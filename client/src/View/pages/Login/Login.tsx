                    ...
                    <div className={"h-auto mt-4 mb-4 pl-9 mx-auto border-white border-[0.5] bg-white"}>
                        ...
                        <form className={"h-auto p-2 justify-center mr-10"}>
                            ...
                            <div className="pb-2">
                                ...
                                <input className="float-right border-[1px] border-yellow-600" type={"email"}/>
                            </div>

                            <div className="pb-2">
                                <label className="text-[10px] pr-2 font-bold">Password: </label>
                                <input className="float-right border-[1px] border-yellow-600" type={"password"}/>
                            </div>

                            <div className={"mt-2 mt-5"}>
                                <button className="mt-2 w-full bg-yellow-300 text-[15px] p-[6px] hover:text-white">Sing In</button>
                            </div>
